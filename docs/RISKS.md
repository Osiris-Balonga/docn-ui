...
Destination/visibilité Git, auteur et licence, URL publique et hébergeur, autorisation de pousser/fusionner/publier. Leur absence n'empêche pas les lots locaux. Les noter dans `status.json.externalDecisions`, jamais créer un compte ou choisir un nom public sans accord.
